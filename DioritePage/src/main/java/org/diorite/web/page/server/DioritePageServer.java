...
public class DioritePageServer implements ServletContextListener
{
    ...
    private void initHibernate()
    {
        ...
        this.hibernateSessionFactory = new Configuration().addProperties(properties).addPackage("org.diorite.web.page.shared").addPackage("org.diorite.web.page.server").buildSessionFactory();
    }
}
